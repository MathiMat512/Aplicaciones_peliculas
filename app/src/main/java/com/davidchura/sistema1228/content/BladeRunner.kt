...
class BladeRunner : ComponentActivity() {
                ...
                Column(
                    ...
                    Box {
                        Box(
                            ...
                            Image(
                                painter = painterResource(id = R.drawable.bladerunner2),
                                modifier = Modifier
                                    .fillMaxSize(),
                            ...
                            IconButton(
                                onClick = { startActivity(Intent(this@BladeRunner, HomeActivity::class.java)) },
                    ...
                    Row(
                        ...
                        Button(onClick = {
                            startActivity(Intent(this@BladeRunner, TermsActivity::class.java))
                        }) {
                            Text("Ver Ahora")
                        }
                    ...
                    Row(
                        ...
                        Button(
                            ...
                            Text(text = "2017 | Accion | Ciencia y Ficcion | USA")
                        }
                    }
                    Column(
                        modifier = Modifier
                        ...
                        Row(
                            ...
                            Button(onClick = {
                                startActivity(Intent(this@BladeRunner, HomeActivity::class.java))
                            }) {
